...
class Formatter
{
    ...
    public function getStartMark(string $style): string
    {
    ...
    private function buildStartMark(array $style): string
    {
     ...
     */
    public function format(string $text = '', string $style = 'none'): string
    {
        return $this->getStartMark($style) . $text . $this->getClearMark();
    }

    public function decorate(string $text, array $style): string
    {
